# Benchmark - LLM benchmark evaluation module: standardized benchmarks, provider comparison.
...
challenge:
	../challenges/scripts/benchmark_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Benchmark - LLM benchmark evaluation module: standardized benchmarks, provider comparison."
	@echo ""
	@echo "Build & Test:"
